...
import { FaHome, FaProjectDiagram, FaInfoCircle, FaEnvelope, FaDownload } from 'react-icons/fa';
...
const Navbar = () => {
  ...
  document.addEventListener('scroll', () => {
    const navbarLayer = document.querySelector('.navbar-layer');
    const scrollPosition = window.scrollY;

    if (scrollPosition > 50) {
      navbarLayer.classList.add('visible');
    } else {
      navbarLayer.classList.remove('visible');
    }
  });
          ...
          <div className={`menu-overlay ${menuOpen ? 'show' : ''}`}>
            <nav>
              <ul>
                ...
                <li>
                  <button onClick={toggleTheme} aria-label="Toggle Theme" className='theme-icon'>
                    {theme === 'dark' ? (
              ...
              <button className="close-menu" onClick={toggleMenu} aria-label="Close">
                ×
              </button>
            </nav>
          </div>
